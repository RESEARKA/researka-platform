...
import FirebaseClientOnly from '../firebase/FirebaseClientOnly';
    ...
    >
      <VStack align="stretch" spacing={4}>
        ...
        >
          <Box>
            <Text fontWeight="bold" mb={2}>Authors:</Text>
            <VStack align="start" spacing={2} data-author-name>
              {citation.authors.map((author, index) => (
                <Box key={`author-citation-${index}`}>
                  <Text>
                    {author.given} {author.family}
                    {author.affiliation && (
                      <Text as="span" fontSize="sm" color="gray.600" ml={1} data-author-affiliation>
                        ({author.affiliation})
                      </Text>
                    )}
                    {author.orcid && (
        ...
        <Box>
          ...
          <FirebaseClientOnly
            fallback={<Text>Loading citation...</Text>}
          >
            <Text>
